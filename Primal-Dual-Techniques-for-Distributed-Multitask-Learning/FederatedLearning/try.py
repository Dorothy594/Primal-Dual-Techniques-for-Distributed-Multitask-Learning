...
final_mean = []
for i in out_prob:
    B, weight_vec, true_labels, datapoints = get_sbm_2blocks_data(weight, pin=0.5, pout=0.01*i, is_torch_model=False)
